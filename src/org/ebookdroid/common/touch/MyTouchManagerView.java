...
public class MyTouchManagerView extends View {
    ...
    private final MYIActivityController base;

    private final Paint bgPaint;
    private final Paint gridPaint;
    private final MyActionController<MyTouchManagerView> actions;
    ...
    public MyTouchManagerView(final MYIActivityController base) {
        super(base.getContext());
        this.base = base;
        this.actions = new MyActionController<MyTouchManagerView>(base, this);
    ...
    protected void processRegion() {
        if (profile != null) {
            ...
            if (current != null) {
                final MyTouchConfigDialog dlg = new MyTouchConfigDialog(base, this, profile, current);
                dlg.show();
            }
        }
