...
import org.emdev.ui.actions.MyDialogController;
import org.emdev.ui.adapters.ActionsAdapter;

import the.pdfviewerx.R;

public class MyTouchConfigDialog extends Dialog {

    private final MyTouchManagerView view;
    private final MyDialogController<MyTouchConfigDialog> actions;
    ...
    public MyTouchConfigDialog(final MYIActivityController base, final MyTouchManagerView view, final TouchProfile profile,
            final Region region) {
        super(base.getContext());
        this.view = view;
        this.profile = profile;
        this.actions = new MyDialogController<MyTouchConfigDialog>(this);
