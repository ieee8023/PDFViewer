...
public class MyNavigationHistory {

    private final MYIActivityController base;

    private final LinkedList<Position> history = new LinkedList<MyNavigationHistory.Position>();

    public MyNavigationHistory(final MYIActivityController base) {
        this.base = base;
    }
