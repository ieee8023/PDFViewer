...
public class MyGoToPageDialog extends Dialog {

    final MYIActivityController base;
    final SeekBarIncrementHandler handler;
    BookmarkAdapter adapter;
    Bookmark current;
    MyDialogController<MyGoToPageDialog> actions;
    int offset;

    public MyGoToPageDialog(final MYIActivityController base) {
        super(base.getContext());
        this.base = base;
        this.actions = new MyDialogController<MyGoToPageDialog>(this);
