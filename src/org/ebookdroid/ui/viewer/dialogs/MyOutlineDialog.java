...
import org.ebookdroid.ui.viewer.adapters.MyOutlineAdapter;
...
public class MyOutlineDialog extends Dialog implements OnItemClickListener {

    final MYIActivityController base;
    final List<OutlineLink> outline;
    final MyActionController<MyOutlineDialog> actions;

    public MyOutlineDialog(final MYIActivityController base, final List<OutlineLink> outline) {
        super(base.getContext());
        this.base = base;
        this.outline = outline;
        this.actions = new MyActionController<MyOutlineDialog>(base, this);
    }
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        final MyOutlineAdapter adapter = new MyOutlineAdapter(getContext(), base, outline, current);
