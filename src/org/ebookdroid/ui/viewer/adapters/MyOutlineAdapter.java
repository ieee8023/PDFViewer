...
public class MyOutlineAdapter extends BaseAdapter {
    ...
    public MyOutlineAdapter(final Context context, final MYIActivityController base, final List<OutlineLink> objects,
