...
public class MyViewStub implements MyIView {

    public static final MyViewStub STUB = new MyViewStub();
    ...
    @Override
    public MYIActivityController getBase() {
        return MyActivityControllerStub.STUB;
    }
