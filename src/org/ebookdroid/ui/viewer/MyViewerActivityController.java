...
import org.ebookdroid.common.keysbinding.MyKeyBindingsDialog;
...
import org.ebookdroid.core.MyNavigationHistory;
...
import org.ebookdroid.ui.viewer.dialogs.MyGoToPageDialog;
...
import org.ebookdroid.ui.viewer.stubs.MyActivityControllerStub;
...
import org.emdev.ui.MyAbstractActivityController;
...
import the.pdfviewerx.MyFolderDlg;
import the.pdfviewerx.MyViewerActivity;
import the.pdfviewerx.R;
import the.pdfviewerx.ViewerActivity;

public class MyViewerActivityController extends MyAbstractActivityController<MyViewerActivity> implements
        MYIActivityController, DecodingProgressListener, CurrentPageListener, IAppSettingsChangeListener,
    ...
    private MySearchModel searchModel;
    ...
    private final MyNavigationHistory history;
     ...
     */
    public MyViewerActivityController(final MyViewerActivity activity) {
        super(activity, BEFORE_CREATE, BEFORE_RECREATE, AFTER_CREATE, ON_POST_CREATE, ON_DESTROY);

        intent = activity.getIntent();

        history = new MyNavigationHistory(this);
     ...
     */
    @Override
    public void beforeCreate(final MyViewerActivity activity) {
     ...
     */
    @Override
    public void beforeRecreate(final MyViewerActivity activity) {
        final AppSettings newSettings = AppSettings.current();
     ...
     */
    @Override
    public void afterCreate(final MyViewerActivity activity, final boolean recreated) {
        ...
        documentModel = MyActivityControllerStub.DM_STUB;
        searchModel = new MySearchModel(this);
        ...
        documentModel.addListener(MyViewerActivityController.this);
        progressModel = new DecodingProgressModel();
        progressModel.addListener(MyViewerActivityController.this);
    ...
    public void askPassword(final String fileName, final int promtId) {
        ...
        final MyActionDialogBuilder builder = new MyActionDialogBuilder(getManagedComponent(), this);
    ...
    public void decodingProgressChanged(final int currentlyDecoding) {
        final Runnable r = new Runnable() {
            ...
            public void run() {
                try {
                    final MyViewerActivity activity = getManagedComponent();
    ...
    public void showOutline(final ActionEx action) {
        ...
        if ((outline != null) && (outline.size() > 0)) {
            final MyOutlineDialog dlg = new MyOutlineDialog(this, outline);
            dlg.show();
        } else {
    ...
    public void showGotoDialog(final ActionEx action) {
        final MyGoToPageDialog dlg = new MyGoToPageDialog(this);
        dlg.show();
    }
    ...
    public void showKeyBindingsDialog(final ActionEx action) {
        final MyKeyBindingsDialog dlg = new MyKeyBindingsDialog(this);
        dlg.show();
    }
     ...
     */
    @Override
    public final MySearchModel getSearchModel() {
        return searchModel;
    }
    ...
    @ActionMethod(ids = { R.id.mainmenu_zoom, R.id.actions_toggleTouchManagerView, R.id.mainmenu_search,
            R.id.mainmenu_crop })
    public void toggleControls(final MyActionEx myActionEx) {
        final View view = myActionEx.getParameter("view");
        final DocumentViewMode mode = myActionEx.getParameter("mode");
        if (mode != null && bookSettings != null && bookSettings.viewMode != mode) {

            final MyActionDialogBuilder builder = new MyActionDialogBuilder(getContext(), this);
    ...
    public void showSaveDlg(final ActionEx action) {
        final MyFolderDlg dlg = new MyFolderDlg(this);
...
//        }
    ...
    final class SearchTask extends AsyncTask<String, String, RectF> implements MySearchModel.ProgressCallback,
            OnCancelListener {
        ...
        protected void onPostExecute(final RectF result) {
            ...
            if (result != null) {
                ...
                final MySearchControls sc = getManagedComponent().getSearchControls();
