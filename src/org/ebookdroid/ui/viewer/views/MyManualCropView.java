...
public class MyManualCropView extends View {
    ...
    private final ActionController<MyManualCropView> controller = new ActionController<MyManualCropView>(this);
    ...
    public MyManualCropView(final MYIActivityController base) {
