 ...
 */
public class MyDialogController<ManagedComponent extends Dialog> extends AbstractComponentController<ManagedComponent> {
     ...
     *            managed dialog
     */
    public MyDialogController(final ManagedComponent dialog) {
        this(null, dialog);
    }
     ...
     *            managed component
     */
    public MyDialogController(final IActionController<?> parent, final ManagedComponent managedComponent) {
