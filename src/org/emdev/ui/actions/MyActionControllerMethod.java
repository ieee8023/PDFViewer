...
public class MyActionControllerMethod {
    ...
    private final MyIActionController<?> m_controller;

    private final MyActionEx m_action;
     ...
     *            action id
     */
    MyActionControllerMethod(final MyIActionController<?> controller, final MyActionEx action) {
     ...
     */
    public Object invoke(final MyActionEx myActionEx) throws Throwable {
        final Method m = getMethod();
        if (m != null) {
            return m.invoke(m_target, myActionEx);
        } else {
            throw m_errorInfo;
        }
    }
    ...
    Method getMethod() {
        if (m_method == null && m_errorInfo == null) {
            ...
            for (MyIActionController<?> c = m_controller; m_method == null && c != null; c = c.getMyParent()) {
