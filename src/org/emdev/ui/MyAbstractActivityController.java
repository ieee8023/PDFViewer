...
import org.emdev.ui.actions.MyAbstractComponentController;

public class MyAbstractActivityController<A extends Activity> extends MyAbstractComponentController<A> implements
        ActivityEvents {
    ...
    protected MyAbstractActivityController(final A activity, final int... events) {
        super(activity);
